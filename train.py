...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='./weights/yolov8l.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default="/models/transformer/yolov5l-fsmamba-v8.yaml", help='model.yaml path')
    parser.add_argument('--data', type=str, default="/data/DroneVehicle.yaml", help='data.yaml path')
    parser.add_argument('--hyp', type=str, default="/data/hyp.scratch.yaml", help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=150)
    parser.add_argument('--batch-size', type=int, default=4, help='total batch size for all GPUs')
    parser.add_argument('--img-size', nargs='+', type=int, default=[640, 640], help='[train,value, test] image sizes')
